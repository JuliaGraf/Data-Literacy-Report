...
\begin{figure}[ht]% this figure made with
  ...
  \caption{The mean daily visitors as a function of the mean daily precipitation between 10am and 10pm during the Oktoberfest each year. The green line is the linear regression line of all data points.}
...
\begin{figure}[ht]
  ...
  \caption{Percentage change between the expected and observed number of tourists for the individual counties of Upper Bavaria from 2006 to 2022. The areas in darker purple are those where the number of visitors has been higher than expected.}
  \label{fig:heatmap}
\end{figure}
